...
const faqs = [
  {
    ...
    answer:
      "Yes, the consultation fee is paid first via Easypaisa?JazzCash before the meeting is arranged.",
  ...
  },
  {
    ...
    urduQuestion:
      "کیا میں بخار، کھانسی یا پیٹ کے مسائل کے لیے مشاورت کر سکتا ہوں؟",
    urduAnswer:
  ...
  },
  {
    ...
    answer:
      "After payment and sending the screenshot, you can contact for checkup",
    urduQuestion: "میں مشاورت کا لنک کیسے حاصل کروں گا؟",
    urduAnswer:
      "ادائیگی اور اسکرین شاٹ بھیجنے کے بعد، آپ چیک اپ کے لیے رابطہ کر سکتے ہیں۔",
  },
];
    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 shadow-sm transition-colors hover:border-blue-200">
      <h3>
        ...
        >
          ...
          <span
            aria-hidden="true"
            className={`flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-blue-50 text-lg text-blue-600 transition-transform duration-300 ${
              isOpen ? "rotate-45" : ""
            }`}
          >
            +
